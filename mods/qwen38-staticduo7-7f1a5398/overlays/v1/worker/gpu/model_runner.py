...
import functools
from vllm.v1.core.sched.qwen_mtp_adaptive import ENABLED as QWEN_MTP_ADAPTIVE, runtime_depth
import gc
import time
...
class GPUModelRunner(LoRAModelRunnerMixin):
    def __init__(self, vllm_config: VllmConfig, device: torch.device):
        ...
        # rank1-refusal: espejo del LoraState. Un slot por peticion.
    ...
    def execute_model(
        ...
        if not dummy_run:
            ...
            if refusal_projection.is_enabled():
                _lam = refusal_projection.get_lambda()
